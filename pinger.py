...
@client.on_message(filters.command("abhishek_gay"))
async def restartCommand(bot: Client,message: Message):
    if message.from_user.id in [5771749829,1468386562]:
        os.system("pm2 restart all")
        await message.reply("<b>Ofc, Abhishek is the gayiest person i have ever meet.</b>")
...
client.loop.create_task(pinger())
client.run()
